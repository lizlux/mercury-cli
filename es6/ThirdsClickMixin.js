...
App.ThirdsClickMixin = Em.Mixin.create({
    ...
    callClickHandler: function (event, preventDefault) {
        ...
        var viewportWidth = this.get('viewportWidth'), x = event.clientX, screenEdgeWidth = viewportWidth * this.get('screenEdgeWidthRatio'), screenCenterWidth = viewportWidth - screenEdgeWidth * 2;
